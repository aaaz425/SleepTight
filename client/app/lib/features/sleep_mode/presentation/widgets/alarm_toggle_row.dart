...
import 'package:app/features/sleep_mode/presentation/provider/alarm_checkbox_provider.dart';
...
class AlarmToggleRow extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isChecked = ref.watch(alarmCheckboxProvider);
    final notifier = ref.read(alarmCheckboxProvider.notifier);
            ...
            child: ConstrainedBox(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Image.asset('assets/images/clock_no_alarm.png', width: 100),
